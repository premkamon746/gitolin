				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-mobile"></i>ชั้น <?=$grade_name?>
							</div>
						</div>
							...
							<?php foreach ($sc->result() as $s) {?>
								<tr class="ui-state-default" id="<?=$s->id?>">
									...
									<td width="100" align="center"  >
											...
											onclick="window.location = '<?=base_url("school/student/index/".$s->id."/".$s->name)?>' " ></i>
									</td>
									<td width="100" align="center" >
...
<script>
	...
	function deleteClassRoom(id){
		if(confirm("ต้องการลบ ?")){
			window.location = "<?=base_url("school/classroom/delete/$grade_id")?>/"+id;
			}
	}
</script>
