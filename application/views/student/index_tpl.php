									...
									<div class="portlet-body form">
										...
										<input type="hidden" id="student_id" name="student_id"  />
											<div class="form-body">
												...
												<div class="form-group">
													<label class="control-label col-md-3">ชั้น/ห้อง</label>
													<div class="col-md-9">
														<input type="text" id="class" name="class"  class="form-control"
														value="<?=isset($class)?$class:'' ?>" style="width:40px;float:left;" />
														<div style="float:left;">/</div>
														<input type="text" id="room" name="room"  class="form-control"
														value="<?=isset($room)?$room:'' ?>"  style="width:40px;float:left;"/>
